...
class AreaVO(models.Model):
    ...
    area_name = models.CharField(db_column="area_name", max_length=255,
                                 default="", null=False)
    area_pincode = models.TextField(db_column="area_pincode", max_length=255,
                                    default="", null=False)
...
class UserVO(models.Model):
    ...
    user_gender = models.CharField(db_column="user_gender", max_length=10,
                                   default="", null=False)
    user_address = models.CharField(db_column="user_address", max_length=500,
                                    default="", null=False)
    user_hobby = models.CharField(db_column="user_hobby", max_length=50,
                                  default="", null=False)
...
class ComplainVO(models.Model):
    ...
    complain_status = models.CharField(db_column="complain_status",
                                       max_length=255, default="", null=False)
    complain_login_vo = models.ForeignKey(LoginVO,
                                          db_column="complain_login_id",
                                          on_delete=models.CASCADE, null=False)

    def __str__(self):
        return '{} {} {} {}'.format(self.complain_subject,
                                    self.complain_description,
                                    self.complain_datetime,
...
class FeedbackVO(models.Model):
    feedback_id = models.AutoField(db_column="feedback_id", primary_key=True,
                                   null=False)
    feedback_description = models.TextField(db_column="feedback_description",
                                            max_length=500, default="",
                                            null=False)
    ...
    feedback_rating = models.IntegerField(db_column="feedback_rating",
                                          null=True)
    feedback_login_vo = models.ForeignKey(LoginVO,
                                          db_column="feedback_login_id",
                                          on_delete=models.CASCADE, null=False)

    def __str__(self):
        return '{} {} {}'.format(self.feedback_description,
                                 self.feedback_datetime, self.feedback_rating)
